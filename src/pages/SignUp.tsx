        ...
        <div className="signup-wrapper">
            <div className="signup-card">
                <div className="signup-header">
                    ...
                    <p>Join us to get started with ReactMentoring</p>
                </div>
                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div className="form-group">
                        ...
                        {errors.userName && (
                            <p style={{ color: '#ef4444', fontSize: '0.85rem', marginTop: '0.5rem', marginLeft: '0.5rem' }}>
                    ...
                    <div className="form-group">
                        <div className="input-wrapper">
                            <svg className="input-icon" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke={errors.confirmPassword ? "#ef4444" : "currentColor"}>
